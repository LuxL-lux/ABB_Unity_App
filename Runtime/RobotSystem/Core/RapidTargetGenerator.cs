...
namespace RobotSystem.Core
{
    ...
    public class RapidTargetGenerator : MonoBehaviour
    {
        ...
        [SerializeField]
        private bool autoFindRobot = true;
        ...
        private string currentJoinTarget = "";

        [SerializeField, TextArea(2, 4)]
        private string currentRobTarget = "";

        [Header("Display Options")]
        [SerializeField]
        private bool logUpdates = false;
        ...
        public void UpdateTargets()
        {
            ...
            try
            {
                ...
                if (jointAngles != null && jointAngles.Length >= 6)
                {
                    ...
                    // Generate ROBTARGET
                    currentRobTarget = FormatRobTarget(
                        tcpPosition,
                        tcpRotation,
                        robotConfiguration
                    );
