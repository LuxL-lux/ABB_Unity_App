...
namespace RobotSystem.ABB
{
    ...
    public class ABBFlangeAdapter : MonoBehaviour, IRobotVisualization
    {
        ...
        private void InitializeFlangeController()
        {
            ...
            {
                Debug.LogError("[ABB Flange] No Controller component assigned. Please assign the Controller.cs script.");
                return;
            }
            ...
            try
            {
                ...
                {
                    Debug.LogError($"[ABB Flange] Component {controllerType.Name} is not the expected Controller script. Please assign Controller.cs component.");
                    return;
                }
        ...
        private bool TryUpdateJointAnglesMainThread(float[] jointAngles)
        {
            ...
            try
            {
                ...
                var jointTargetType = System.Type.GetType("Preliy.Flange.JointTarget, Preliy.Flange");
                ...
                var jointTarget = System.Activator.CreateInstance(jointTargetType, new object[] { jointAngles });
                if (jointTarget == null)
                {
